...
public:
	this(NVGContext nvg)
	{
		...
		import arsd.nanovega : createFontMem; //, createFont;
		...
		// mFontNormal = nvg.createFont("sans", "C:/windows/fonts/simkai.ttf");
		// mFontBold = nvg.createFont("sans-bold", "C:/windows/fonts/simhei.ttf");
	...
	/// The width of scrollbar (default: `12`).
	int mScrollbarWidth;
